...
<div className='flex flex-col gap-5'>
  <FooterColumn title={FOOTER_CONTACT_INFO.title}>
    { FOOTER_CONTACT_INFO.links.map((link)=>(
      ...
      <Link to="/" key={link.label}  className='flex flex-col gap-4 md:flex-col lg:flex-row'>
...
<div className='flex'>
  <FooterColumn>
    <ul className='flex gap-4'>
      ...
      <p className="text-center regular-14 text-gray-30">2024 Shoppee | All copy rights reserved</p>
      </div>
    </footer>
  )
}
