...
function Item({id,name,image,old_price,new_price}) {
  return (
    <div className='rounded-xl overflow-hidden shadow-lg'>
        <div className='relative flexCenter group
         overflow-hidden transition-all duration-100 '>
            ...
            <img src={image} onClick={window.scroll(0,0)}alt="productImage" className='w-full block object-cover group-hover:scale-110 transition-all duration-1000 '/>
        </div>
